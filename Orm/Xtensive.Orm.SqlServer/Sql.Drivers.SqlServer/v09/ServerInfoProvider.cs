...
namespace Xtensive.Sql.Drivers.SqlServer.v09
{
  internal class ServerInfoProvider : Info.ServerInfoProvider
  {
    ...
    public override DataTypeCollection GetDataTypesInfo()
    {
      ...
      //TODO: DateOnly disable
      types.DateOnly = DataTypeInfo.Range(SqlType.Date, common | index, new ValueRange<DateOnly>(new DateOnly(1, 1, 1), new DateOnly(9999, 12, 31)), "dateOnly");
